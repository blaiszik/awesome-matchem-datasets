...
| [NIST AM-Bench](https://www.nist.gov/ambench) | Additive manufacturing (LPBF/DED) process–structure–property | Multi-benchmark suite | Experimental | Various |
...
| [AlphaFlow](https://github.com/AbolhasaniLab) | Self-driving QD shell-growth synthesis (RL) | ~9,000+ condition–outcome spectra | Experimental | Code/Data |
...
- **NIST AM-Bench**: Flagship additive-manufacturing benchmark (LPBF & DED of IN625/IN718/15-5 SS/Ti-6Al-4V/polymers) spanning laser power/scan speed/layer thickness → melt-pool geometry, in-situ thermography, phase transformations, 3D microstructure, residual strain, and tensile/fatigue properties — the full feedstock→microstructure→property chain, built for model validation. NIST public domain. 🔗 Verify: https://www.nist.gov/ambench · data https://data.nist.gov.
...
- **AlphaFlow (NC State)**: Reinforcement-learning fluidic platform for multi-step CdSe quantum-dot shell growth — ~9,000+ in-situ spectral condition→outcome measurements where injection sequence/volumes drive absorption/PL outcomes and policy updates. CC-BY 4.0. 🔗 Verify: https://github.com/AbolhasaniLab · Nat. Commun. Mar 2023.
