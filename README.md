...
Added 12 new datasets focusing on catalysis, reaction kinetics, cluster chemistry, experimental solubility, and literature mining to enhance resources for computational chemistry and machine learning applications.

#### 🧮 Computational Datasets (6 datasets)
...
#### 📚 LLM Training Datasets (2 datasets)
